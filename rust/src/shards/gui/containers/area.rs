...
lazy_static! {
  static ref AREA_PARAMETERS: Parameters = vec![
    (cstr!("Position"), cstr!("todo"), FLOAT2_TYPES_SLICE,).into(),
    (cstr!("Anchor"), cstr!("todo"), STRING_OR_NONE_SLICE,).into(),
    (
      cstr!("Contents"),
  ...
  fn activate(&mut self, context: &Context, input: &Var) -> Result<Var, &str> {
    ...
    if !self.contents.is_empty() {
      ...
      let area = if self.anchor.get().is_none() {
        ...
        area.anchor(try_to_align2(self.anchor.get())?, offset)
      };
...
fn try_to_align2(var: &Var) -> Result<egui::Align2, &str> {
  let str: &str = var.try_into()?;
  match str {
    "BottomLeft" => Ok(egui::Align2::LEFT_BOTTOM),
    "Left" => Ok(egui::Align2::LEFT_CENTER),
    "TopLeft" => Ok(egui::Align2::LEFT_TOP),
    "Bottom" => Ok(egui::Align2::CENTER_BOTTOM),
    "Center" => Ok(egui::Align2::CENTER_CENTER),
    "Top" => Ok(egui::Align2::CENTER_TOP),
    "BottomRight" => Ok(egui::Align2::RIGHT_BOTTOM),
    "Right" => Ok(egui::Align2::RIGHT_CENTER),
    "TopRight" => Ok(egui::Align2::RIGHT_TOP),
    _ => Err("Invalid value for Align2"),
  }
}
