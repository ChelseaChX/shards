...
struct RTake : public Take {
  ...
  static inline chainblocks::ParamsInfo indicesParamsInfo = chainblocks::ParamsInfo(chainblocks::ParamsInfo::Param(
      "Indices", CBCCSTR("One or multiple indices to extract from a sequence."), CoreInfo::RTakeTypes));
...
struct Slice {
  static inline chainblocks::ParamsInfo indicesParamsInfo = chainblocks::ParamsInfo(
      chainblocks::ParamsInfo::Param("From", CBCCSTR("From index."), CoreInfo::IntsVar),
      chainblocks::ParamsInfo::Param("To", CBCCSTR("To index (excluding)."), CoreInfo::IntsVarOrNone),
      chainblocks::ParamsInfo::Param("Step", CBCCSTR("The increment between each index."), CoreInfo::IntType));
